...
The response object will also include your credits to use for bidding. Each user is given 1,000 credits by default.
...
const response = await fetch(`${API_BASE_URL}/api/v1/auction/listings`, options)
