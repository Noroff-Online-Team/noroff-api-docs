...
<Callout type="info">
  The Noroff API has several authentication endpoints. Which one you should use
  depends on which endpoints you are trying to access.
</Callout>
...
You should use the [Auction House Authentication](./auction-house-endpoints/authentication.md) if you are trying to access any of the Auction House endpoints.
