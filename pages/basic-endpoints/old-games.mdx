...
<Properties
  options={[
    ...
    ['released', 'string', 'The year the game was released.'],
    ['image', 'string', 'The image of the game.'],
    ['genre', 'array', 'A string array of the genres of the game.'],
  ]}
/>
...
This endpoint allows you to retrieve all old games.
...
This endpoint allows you to retrieve a single old game by its id.
...
This endpoint allows you to retrieve a random old game.
